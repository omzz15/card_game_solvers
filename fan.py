...
class Solution:
    ...
    def get_card_lists(self):
        ...
        cl14 = list()
        cl14.append(Card(13, CardSuite.DIAMOND))
        cl14.append(Card( 7, CardSuite.CLUB))
        cl14.append(Card( 6, CardSuite.HEART))
        
        cl15 = list()
        cl15.append(Card(13, CardSuite.DIAMOND))
        cl15.append(Card( 7, CardSuite.CLUB))
        cl15.append(Card( 6, CardSuite.HEART))
        
        cl16 = list()
        cl16.append(Card(13, CardSuite.DIAMOND))
        cl16.append(Card( 7, CardSuite.CLUB))
        cl16.append(Card( 6, CardSuite.HEART))
        
        cl17 = list()
        cl17.append(Card(13, CardSuite.DIAMOND))
        cl17.append(Card( 7, CardSuite.CLUB))
        cl17.append(Card( 6, CardSuite.HEART))
        
        cl18 = list()
        cl18.append(Card(13, CardSuite.DIAMOND))
